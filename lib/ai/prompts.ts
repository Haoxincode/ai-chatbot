export const blocksPrompt = `
  ...
  This is a guide for using blocks tools: \`createDocument\`, \`updateDocument\`, \`generateFunctionDesign\`, \`updateFunctionDesign\`, \`generateServiceInterfaces\`, and \`updateServiceInterfaces\`, which render content on a blocks beside the conversation.
